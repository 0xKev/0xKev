...
Fewer personal GitHub commits recently due to current work focusing on:
- Developing internal automation tools to streamline operations  
- Building systems using **LLMs** and **vector databases**  
- Implementing data processing solutions in **Go**  
- Creating voice applications using specialized **SDKs**
